...
class InstructorsController < ApplicationController
  ...
  def destroy
    @instructor.destroy
    respond_to do |format|
      format.html { redirect_to root_path, notice: 'Instructor was successfully destroyed.' }
  ...
  def instructor_params
    params.require(:instructor).permit(:email, :nickname, :password, :siret, :website, :description, :logo)
  end
end
